export class CONFIGURATION {
    ...
    */
    static readonly PROJET = 'cegep-al';  // CECI EST LE NOM DU PROJET DANS GOOGLE CLOUD
    static readonly REGIONLOCATION = 'northamerica-northeast1'; // CECI EST LA REGION OU SE TROUVE LE PROJET
    static readonly DATASET = 'demoa24'; // CECI EST LE NOM DE LA BASE DE DONNEES DANS GOOGLE CLOUD
}
